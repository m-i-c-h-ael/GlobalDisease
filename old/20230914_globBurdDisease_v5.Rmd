...
t= unique(allTime_HT_asi$year - 1990)
...
for(i in 1:dim(MCMCcoefs_DF)[1]){
  ...
  predDF[i,]= MCMCcoefs_DF$b0_median[i] + MCMCcoefs_DF$b1_median[i]*t -MCMCcoefs_DF$b2_median[i]* t_pastInv
}
colnames(predDF)= t+1990
