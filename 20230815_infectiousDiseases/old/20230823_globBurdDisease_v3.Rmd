...
```{R}
DeathrateDown_DF$loc_cause= paste(DeathrateDown_DF$location,DeathrateDown_DF$cause,sep=', ')
summary(DeathrateDown_DF[,3:6])
str(DeathrateDown_DF)

#manually sorted: factor levels of 'loc_cause' are ordered by year
DeathrateDown_DF_sort= DeathrateDown_DF
DeathrateDown_DF_sort$loc_cause= factor(DeathrateDown_DF_sort$loc_cause,ordered=TRUE,
           levels= DeathrateDown_DF_sort$loc_cause[order(DeathrateDown_DF_sort$t_inflec_median)])
...
DrD_melt= melt(DeathrateDown_DF_sort,id.vars= c('loc_cause','location','cause'),
             measure.vars=c('b0_median','b1_median','b2_median','t_inflec_median'))
str(DrD_melt)

DrD_melt$coefType= rep('rate',dim(DrD_melt)[1])
DrD_melt$coefType[DrD_melt$variable=='b0_median']= 'basel.'
