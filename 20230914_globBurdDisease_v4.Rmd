...
* split Tuberculosis: no/yes (#22)
       -> no tuberculosis strongly enriches in '-'; tuberculosis in '+'
* among the non-tuberculosis samples, all Eastern European, East Asian or Central European  countries are '-' 
```{python}
#X_train.head(2)
X_train.shape
