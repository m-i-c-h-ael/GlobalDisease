...
I will next use the technique of summarizing time courses into four parameters to learn the factors associated with declining deaths (b2 < 0). I will use a random forest approach.
...
if(! file.exists('./20230915_MCMCcoefs_HTsex_age.csv')){ #execute only if not yet done
  ...
  # write output so you do not need to run this code every time
  write.csv(MCMCcoefs_DF, './20230915_MCMCcoefs_HTsex_age.csv', row.names = FALSE)
} else {
